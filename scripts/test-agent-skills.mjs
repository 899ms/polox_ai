...
assert.deepEqual(searchAgentSkills('').map(s => s.id), ['product-hunt-gallery', 'app-store-graphics', 'sketch-to-image', 'image-text-editor', 'image-annotation-edit', 'image-object-removal', 'image-layer-splitter', 'long-form-video'])
