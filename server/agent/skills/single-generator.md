...
For Image Text Editor (`image-text-editor` / `/image-text-editor`), follow image-text-editor.

For Image Layer Splitter (`image-layer-splitter` / `/image-layer-splitter`), follow image-layer-splitter.
